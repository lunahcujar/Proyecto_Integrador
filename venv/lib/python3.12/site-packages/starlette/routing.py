...
class BaseRoute:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        """
        A route may be used in isolation as a stand-alone ASGI app_.
...
class Mount(BaseRoute):
    def __init__(
        ...
        *,
        ...
        assert app is not None or routes is not None, "Either 'app_=...', or 'routes=' must be specified"
    ...
    def __repr__(self) -> str:
        class_name = self.__class__.__name__
        name = self.name or ""
        return f"{class_name}(path={self.path!r}, name={name!r}, app_={self.app!r})"
...
class Host(BaseRoute):
    ...
    def __repr__(self) -> str:
        class_name = self.__class__.__name__
        name = self.name or ""
        return f"{class_name}(host={self.host!r}, name={name!r}, app_={self.app!r})"
